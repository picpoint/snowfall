...
function snows() {                                                     // ф-ия снежинка
  ...
  img.style.left = startX + 'px';                                       // присваиваем сгенерированное значение позоции относительно верхнего уровня документа
  img.style.top = startY + 'px';                                      // присваиваем сгенерированное значение позоции относительно левого уровня документа
